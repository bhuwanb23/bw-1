        ...
        <div className="rounded-3xl border border-white/20 bg-gradient-to-br from-black/20 to-black/10 backdrop-blur-xl p-12">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button 
              ...
              className="px-8 py-4 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/30 flex items-center gap-2"
            >
