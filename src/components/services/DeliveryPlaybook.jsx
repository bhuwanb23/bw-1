        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_420px]">
          <div className="rounded-3xl border border-white/10 bg-black/30 backdrop-blur-xl p-4 md:p-6">
              ...
              {weeks.map((w) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-full border px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] transition-all duration-300 transform-gpu hover:-translate-y-0.5 hover:shadow-[0_16px_45px_rgba(0,0,0,0.35)] ${
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border border-white/10 bg-black/30 p-5 transition-all duration-300 hover:-translate-y-0.5 hover:border-white/20 hover:bg-white/5 hover:shadow-[0_24px_70px_rgba(0,0,0,0.35)]">
